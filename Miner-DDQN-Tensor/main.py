...
if __name__ == "__main__":
    ...
    for episode_i in range(0, N_EPISODE):
        ...
        print(np.sum(np.unique(policy.actor.l1.weight.cpu().data)),np.sum(np.unique(policy.actor.conv1.weight.cpu().data)),\
            np.sum(np.unique(policy.actor.conv2.weight.cpu().data)), np.sum(np.unique(policy.actor.conv3.weight.cpu().data)),\
            np.sum(np.unique(policy.actor.l2.weight.cpu().data)),np.sum(np.unique(policy.actor.l3.weight.cpu().data)))
        print(np.unique(policy.actor.l3.weight.cpu().data))
