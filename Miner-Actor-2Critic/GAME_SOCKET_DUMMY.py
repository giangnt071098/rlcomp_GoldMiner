...
from bot_DDPG import Bot_DDPG
from bot_TD3_2 import Bot_TD3_2
from bot_newTD3 import Bot_newTD3
...
class GameSocket:
    ...
    def init_bots(self):
        self.bots = [Bot1(2), Bot_TD3_2(3), Bot4(4)]  # use bot1(id=2), bot2(id=3), bot3(id=4)
    ...
    def reset_map(self, id):  # load map info
        ...
        #     for j in range(21):
        #         if self.map[i][j]>=50:
        #             self.map[i][j] = randrange(50, 1300, 50)
        # ### them den day
