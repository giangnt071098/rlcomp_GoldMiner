...
if __name__ == "__main__":
    ...
    parser.add_argument("--notice", default="norm") 
    ...
    if args.policy == "TD3_noise":
        policy = TD3_noise.TD3(**kwargs)
    ...
    for episode_i in range(0, N_EPISODE):
        ...
        if episode_i % 15 == 0:
            ...
            print("MapID: ",mapID, "Actor loss = ", policy.loss_actor, "Critic loss = ", policy.loss_critic)
