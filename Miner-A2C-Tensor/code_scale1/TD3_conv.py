...
class Actor(nn.Module):
	def __init__(self, state_dim, action_dim, max_action, dropout= 0.4):
		...
		self.conv1 = nn.Conv2d(state_dim[0], 32, 3, stride = 1, padding = 1)
...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim, dropout = 0.4):
		...
		# Q1 architecture
		self.conv1_1 = nn.Conv2d(state_dim[0], 32, 3, stride = 1, padding = 1)
		...
		# Q2 architecture
		self.conv1_2 = nn.Conv2d(state_dim[0], 32, 3, stride = 1, padding = 1)
		self.maxp1_2 = nn.MaxPool2d(2, 2)
		self.conv3_2 = nn.Conv2d(32, 64, 3, stride=1, padding=1)
...
class TD3(object):
	def __init__(
		...
		max_action,
		epsilon = 1,
		epsilon_min = 0.03, #The minimum epsilon 
	...
	def train(self, replay_buffer, batch_size=100):
		...
		print(current_Q1.reshape(batch_size,-1), current_Q2)
