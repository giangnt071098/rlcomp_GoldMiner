...
if __name__ == "__main__":
    ...
    print("---------------------------------------")
    scale_map = 3
    INPUTNUM = (12, 21*scale_map, 9*scale_map)#198 #The number of input values for the DQN model
    ...
    for episode_i in range(0, N_EPISODE):
        ...
        total_reward = 0
        observ = np.reshape([np.stack((state, state, state, state), axis = 0)], (12, INPUTNUM[1], INPUTNUM[2]))
        ...
        for step in range(0, maxStep):
            ...
            next_observ = np.append(np.reshape(next_state, (3, INPUTNUM[1], INPUTNUM[2])), observ[:9, :, :], axis = 0)
